...
$s="SELECT web_name From Web where web_id=$id";
...
<h3>Web Page:<?= $ra['web_name']; ?> </h3>
</section>


<form action="rating_web.php" method="post">
<textarea rows="5" cols="20" name="review"  placeholder="Write review here" required>
</textarea>

<input type="hidden" name="web_id" value="<?= $id; ?> ">
