<?php
try{  
$exists = mysqli_query($conn,"SELECT * FROM  App WHERE 1");
}
//if($exists == FALSE)
catch (Exception $e)
{
    ...
    $sql ='CREATE TABLE App (
        ...
        app_name VARCHAR(30) NOT NULL, url VARCHAR(2048)  NOT NULL ,description VARCHAR(120)DEFAULT("APP") NOT NULL,user_id INT(11) NOT NULL,leaderboard_rating FLOAT(11) NOT NULL,reg_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
        )';
